...
public class gp2
{
	...
	// Declarations
	// ----------------------------------------------------
	static Hashtable<String, Person2> m_Persons, m_System ;
	static int m_numActive = 0 ;
	static float m_nTotAmount = 0, m_nSysToAmount ;
	static ArrayList<String> m_exportLines = null;
	static boolean m_bClearing = false ;
	static boolean m_bSys = false ;

	//CONSTANTS
	// Actions
	static final String ADD_PERSON = "*" ;
	static final String ENABLE_PERSON = "+" ;
	static final String DISABLE_PERSON = "-" ;

	//transaction indicators
	static final String REM = "rem" ;
	static final String ALL = "all" ;
	static final String SYS = "sys" ;
	static final String CLEARING = "$" ;
	static final String PERCENTAGE = "%" ;
	static final char 	COMMENT = '#' ;

	//separators
	static final String AMT_INDICATOR = ":" ;
	static final String ITEM_SEPARATOR = "," ;
	static final String READ_SEPARATOR = "\t" ;
	static final String TAB_SEPARATOR = "\t" ;
	//static final String TAB_SEPARATOR = "!" ;
	static final String DUMP_SEPARATOR = " : " ;

	//calculation direction
	static final int 	_FR = 0 ;
	static final int	_TO = 1 ;

	// input read positions
	static final int 	P_ITEM = 0 ;
	static final int	P_CATEGORY = 1 ;
	static final int 	P_VENDOR = 2 ;
	static final int	P_DESC = 3 ;
	static final int 	P_AMOUNT = 4 ;
	static final int	P_FROM = 5 ;
	static final int 	P_TO = 6 ;
	static final int	P_ACTION = 7 ;

	//formatting strings
	static final String lPAD = "lPad[" ;
	static final String rPAD = "]rPad" ;
	static final String lBr = "{" ;
	static final String rBr = "}" ;

	//out file strings
	static final String OUT_FILESEP = "." ;
	static final String OUT_EXTENSION = ".csv" ;
	static final String OUT_FILE = ".out" ;

	// output headers
	static final String H_TRANSACTION_AMOUNTS = "transaction amounts" ;
	static final String H_OWE = "(you owe) / owed to you" ;
	static final String H_INDIVIDUAL_TOTALS = "individual totals" ;
	static final String H_ITEM = "Item" ;
	static final String H_CATEGORY = "Category" ;
	static final String H_VENDOR = "Vendor" ;
	static final String H_DESCRIPTION = "Description" ;
	static final String H_AMOUNT = "Amount" ;
	static final String H_FROM = "From" ;
	static final String H_TO = "To" ;
	static final String H_ACTION = "Action" ;
	static final String H_CHECKSUM = "CheckSum" ;
	static final String H_INDCHECKSUM = "IndCheckSum" ;
	...
	// percentageToAmounts
	// ----------------------------------------------------
	static String percentageToAmounts(float amt, String in, String action)
	{
	...
	// doFromTo
	// ----------------------------------------------------
	static void doFromTo(int idx, float amt, String in)
	{
	...
	// 	sumFromTo
	// ----------------------------------------------------
	static float sumFromTo(float amt, String action)
	{
		// sys account
		float sysAmount = 0 ;
		Iterator<String> iter = m_System.keySet().iterator();
	...
	static String roundAmount(float f)
	{
		try {
			int decimalPlace = 2 ;
	...
	// ProcessTransaction
	// ----------------------------------------------------
	static void ProcessTransaction(String item, String desc, String amt, String from, String to, String action, String def)
	{
		try {
			m_bClearing = false ;
	...
	// prepareToExport
	// ----------------------------------------------------
	static void prepareToExport(String item, String category, String vendor, String desc, String amt, String from, String to, String action, String def)
	{
		String	sTabs = TAB_SEPARATOR ;
		String aLine ;
	...
	static String padAmountString(String sNames[], String embededPers, String unpaddedLine)
	{
		try {
	...
	static String makeOutFilename(String fileName)
	{
		String outFilename = "" ;
	...
	static String padHeader(int nTabs)
	{
		String xHeader = "" ;
		while (nTabs > 0) {
	...
	// ----------------------------------------------------
	static void ReadAndProcessTransactions(String fileName, boolean bExport)
	{
        // open logfile
	...
	throws Exception
	{
        ...
        ReadAndProcessTransactions(fileName, true) ;	// read input file
        //PrintSummary2() ;
   } // end of main
